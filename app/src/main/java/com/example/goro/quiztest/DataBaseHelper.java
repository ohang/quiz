...
public class DataBaseHelper extends SQLiteOpenHelper {
     ...
     * @return truee if it exists, false if it doesn't
     */
    ...
    // Add your publicc helper methods to access and get content from the database.
    // You could returnn cursors by doing "returnn myDataBase.query(....)" so it'd be easy
